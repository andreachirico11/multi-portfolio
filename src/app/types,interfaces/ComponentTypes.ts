import { ContactType } from "../components/pages/contact/contact.config";
...
export type ComponentTypes = NavbarType | ParagraphListType | ContactType | VimeoType | CardSlideshowType;
